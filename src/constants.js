...
export const ICONS = {
  // insert label to icon map here
    ...
    attack_goal: require('./assets/icons/attack_goal_icon_tiny_round_v1.png'),
    attack_pattern: require('./assets/icons/attack_pattern_icon_tiny_round_v1.png'),
    attack_plan: require('./assets/icons/attack_plan_icon_tiny_round_v1.png'),
    attack_step: require('./assets/icons/attack_step_icon_tiny_round_v1.png'),
    ...
    firewall: require('./assets/icons/firewall_icon_v1.png'),
    ...
    ics_sensor: require('./assets/icons/ics_sensor_icon_tiny_square_v1.png'),
    ics_sensor_product: require('./assets/icons/ics_sensor_product_icon_tiny_square_v1.png'),
    ...
    ipv4_addr: require('./assets/icons/ipv4_addr_icon_tiny_round_v1.png'),
    ipv6_addr: require('./assets/icons/ipv6_addr_icon_tiny_round_v1.png'),
    ...
    logical_and: require('./assets/icons/logical_and_icon_v1.png'),
    logical_nand: require('./assets/icons/logical_nand_icon_v1.png'),
    logical_nor: require('./assets/icons/logical_nor_icon_v1.png'),
    logical_not: require('./assets/icons/logical_not_icon_v1.png'),
    logical_nxor: require('./assets/icons/logical_nxor_icon_v1.png'),
    logical_or: require('./assets/icons/logical_or_icon_v1.png'),
    logical_xor: require('./assets/icons/logical_xor_icon_v1.png'),
    mac_addr: require('./assets/icons/mac_addr_icon_tiny_round_v1.png'),
    ...
    network_router: require('./assets/icons/network_router_icon_v1.png'),
    network_switch: require('./assets/icons/network_switch_icon_v1.png'),
    network_traffic: require('./assets/icons/network_traffic_icon_tiny_round_v1.png'),
    network_drive: require('./assets/icons/network_drive_icon_v1.png'),
    nic: require('./assets/icons/nic_icon_v1.png'),
