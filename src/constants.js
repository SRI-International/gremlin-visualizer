...
export const SAVED_QUERIES = {
    ...
    "Theory: CogBias - Anchoring":          "g.V().has('cogbias_class', within('anchoring_bias'))",
    "Theory: CogBias - Confirmation":       "g.V().has('cogbias_class', within('conformation_bias'))",
    "Theory: CogBias - Loss Aversion":      "g.V().has('cogbias_class', within('loss_aversion'))",
    "Theory: CogBias - Representativeness": "g.V().has('cogbias_class', within('representativeness_bias'))",
    "Theory: CogBias - Social/Cultural":    "g.V().has('cogbias_class', within('social_cultural_bias'))",
