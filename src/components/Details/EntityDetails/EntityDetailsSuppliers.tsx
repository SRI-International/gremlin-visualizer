...
import { COMMON_GREMLIN_ERROR, QUERY_ENTITY_SUPPLIER_ENDPOINT} from '../../../constants';
...
export default function EntityDetailsSuppliers() {
  ...
  .outV()
  .hasLabel('Entity')
  .project('id', 'name', 'country', 'risk')
    .by(__.id())
    .by(__.values('name'))
    .by(__.values('country'))
    .by(__.values('risk'))                    
`;
        ...
        try {
            const response = await axios.post(
                QUERY_ENTITY_SUPPLIER_ENDPOINT,
                {
                    host,
                    port,
